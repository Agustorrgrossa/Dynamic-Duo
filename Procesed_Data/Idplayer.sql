...
/* Creamos una nueva columna en la tabla draft_combine_stats denominada ID_nec IDENTITY(1,1) */
...
/* Creamos una nueva columna en la tabla miami_heat_equipo_completo denominada ID_nec IDENTITY(1,1) */
ALTER TABLE [dbo].[miami_heat_equipo_completo]
...
/* Creamos una nueva columna en la tabla nba_stats denominada ID_nec IDENTITY(1,1) */
...
/* Creamos una nueva columna en la tabla salarios denominada ID_nec IDENTITY(1,1) */
